/*привет, вот и твой первый коммит на гитхаб,
 ты рад? я - да. делаю этот комментарий лишь для
того, чтобы я смог загрузить файл на гит с изменениями,
но захотелось вложить сюда какой то смысл и тд
ну ладно давай пока*/
main();
void main()
{
